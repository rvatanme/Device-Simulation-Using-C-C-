...
int main() {
 ...
 /* Calculate relevant parameters for the simulation */
    ...
    fprintf(ofp, "x [um]\tPotential [eV]\tElectric Field1 [V/cm]\tElectric Field2 [V/cm]\tElectron Densities [1/cm^3]\tHole Densities [1/cm^3]\tTotal Charge Density [C/cm^3]\tConduction Band Energy (eV)\n");
    fclose(ofp);
